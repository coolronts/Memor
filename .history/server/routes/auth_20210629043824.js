...
router.get("/userposts/:id", authenticateToken, async(req, res) => {
...
//update Username
router.post("/updateusername", authenticateToken, async(req, res) => {
...
router.post("/updateprofilepic", authenticateToken, async(req, res) => {
    await User.updateOne({ email: req.body.email }, {
...
//update Likes
router.post("/updatelikes", authenticateToken, async(req, res) => {
