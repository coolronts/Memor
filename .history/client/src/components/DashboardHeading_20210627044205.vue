...
<div class="flex justify-center">
    <div  class="relative my-32 mr-24">
        <button @click="dropdownOpen = !dropdownOpen" class="relative z-10 block  p-2 focus:outline-none h-10 px-5 text-gray-100 rounded-lg focus:shadow-outline hover:bg-indigo-800">
