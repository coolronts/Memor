  ...
  <div :class="style.body">
    <div :class="style.container">
      <div :class="style.headingContainer">
        <a href="#" :class="style.heading">Profile</a>
      </div>
      <div :class="style.formContainer">
        <form :class="style.form" onsubmit="event.preventDefault();">
          <div class="flex justify-around">
            <div class="flex flex-col w-1/3 pt-4 mr-2 ">
              <label for="title" :class="style.label">Name</label>
            ...
            <div class="flex flex-col w-1/3 pt-4 ">
              <label for="place" :class="style.label">Email</label>
          ...
          <div class="flex flex-col w-1/2 pt-4 ">
            <label for="place" :class="style.label">Profile Picture</label>
            <img :src="imageBase64" alt=""/> <img class="inline object-cover w-16 h-16 mr-2 rounded-full" src="https://images.pexels.com/photos/2589653/pexels-photo-2589653.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="Profile image"/>
            <input type="file" @change="handleImage" accept="image/*" class="inline block shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"/>
          </div>
