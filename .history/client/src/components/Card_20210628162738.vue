    ...
    data(){
      return{
        style:{
          ...
          title:"cursor uppercase text-center py-2 px-4 text-xl font-medium leading-6 tracking-wide text-gray-300 hover:text-blue-500 cursor-pointer",
          center:"px-4 space-y-2",
          readMore:"cursor font-bold hover:text-blue-400 text-gray-100",
