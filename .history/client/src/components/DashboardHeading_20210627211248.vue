...
<script>
  ...
  export default{
    ...
    data(){
      return{
        style:{
          headingContainer:"flex items-center justify-between h-20 shadow-md",
          heading:" block text-2xl font-bold text-center text-gray-800  lg:text-3xl",  
          body:"flex justify-center",
          username:"w-48 bg-red-50 font-bold text-lg",
          ...
          notificationContainer:"flex items-center py-3 border-b hover:bg-gray-100 -mx-2",
