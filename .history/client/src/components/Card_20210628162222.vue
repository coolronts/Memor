    ...
    data(){
      return{
        style:{
          ...
          title:"uppercase py-2 px-4 text-xl font-medium leading-6 tracking-wide text-gray-300 hover:text-blue-500 cursor-pointer",
          readMore:"font-bold hover:text-blue-400 text-gray-100",
          description:"overflow-hidden h-24 text-gray-400 font-normal leading-5 tracking-wide",
          ...
          likeIcons:"flex items-center space-x-1 text-gray-400",
