<template>
  <!-- component -->
<div class="rounded bg-white w-screen">
        <div class="rounded w-full h-36">
          <img src="https://images.unsplash.com/photo-1526666923127-b2970f64b422?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" class="rounded object-cover" alt="technology" />
          <div class="p-4 pl-0">
