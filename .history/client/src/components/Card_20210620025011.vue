<template>
 <div class="flex justify-between m-6">
  <div class="flex flex-col h-full max-w-lg mx-auto bg-gray-100 rounded-lg">
          <img
          ...
          <div class="flex justify-between -mt-4 px-4">
            <span
              class="inline-block ring-4 bg-red-500 ring-gray-800 rounded-full text-sm font-medium tracking-wide text-gray-900 px-3 pt-0.5"
              >Tech</span
            >
            <span
              class="flex h-min space-x-1 items-center rounded-full text-gray-900 bg-gray-800 py-1 px-2 text-xs font-medium"
            >
              <svg
          ...
          <div class="py-2 px-4">
            <h1
              class="text-xl font-medium leading-6 tracking-wide text-gray-900 hover:text-blue-500 cursor-pointer"
            >
