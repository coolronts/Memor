  ...
  <div :class="style.body">
    ...
    <div :class="[style.postContainer,'relative']">
      ...
      <div :class="style.infoContainer">
        ...
        <div :class="style.content"> <i @click="edit()" :class="style.edit"/> {{post.description}} </div>
      </div>
    </div>
  </div>
</template>
    ...
    data(){
      return{
        style:{
          ...
          edit:"fas fa-edit text-lg text-green-400"
        },
        title:'',
        image:'',
        author:'',
