<template>
  <div :class="style.headingContainer">
    <img :class="style.image" :src="imageBase64" alt="Profile image"/>
      <p class="w-24 font-bold text-lg">Hi Zahid</p>
    ...
    data(){
      return{
        style:{
          ...
          heading:"w-full block text-2xl font-bold text-center text-gray-800  lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300",  
