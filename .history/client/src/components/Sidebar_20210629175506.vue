    ...
    <div :class="style.container">
      ...
      <ul :class="style.list">
        <li @click="switchDashboard(0)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==0}]">
        ...
        <li @click="switchDashboard(1)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==1}]">
        ...
        <li @click="switchDashboard(2)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==2}]">
