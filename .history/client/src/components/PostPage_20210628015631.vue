...
<div class="rounded bg-white w-screen mb-12">
        <div class="rounded  h-24">
          <img src="https://images.unsplash.com/photo-1526666923127-b2970f64b422?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" class="rounded object-cover w-full h-auto" alt="technology" />
          <div class="p-4 pl-0">
