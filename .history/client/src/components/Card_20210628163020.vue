    ...
    data(){
      return{
        style:{
          ...
          center:"px-4 space-y-2 flex flex-col justify-center",
          readMore:"cursor-pointer font-bold hover:text-blue-400 text-gray-100",
          description:"align-center text-justify overflow-hidden h-24 my-4 text-gray-400 font-normal leading-5 tracking-wide",
