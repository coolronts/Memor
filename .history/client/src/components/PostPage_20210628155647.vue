  ...
  export default {
    ...
    data(){
      return{
        ...
        style:{
          body:"mx-12 mb-12",
          buttonContainer:"mr-3 text-white px-4 w-auto h-10 bg-red-600 rounded-full hover:bg-red-700 active:shadow-lg mouse shadow transition ease-in duration-200 focus:outline-none",
          button:"",
