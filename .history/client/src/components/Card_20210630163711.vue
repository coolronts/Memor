    ...
    data(){
      return{
        style:{
          ...
          place:" w-auto self-center inline-block ring-4 bg-red-500 ring-gray-800 rounded-full text-xs font-medium text-center text-gray-100 px-3 pt-1",
          timeContainer:" w-28 justify-center flex h-min space-x-1 items-center rounded-full text-gray-400 bg-gray-800 py-1 px-2 text-xs font-medium",
