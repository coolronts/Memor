        ...
        <div class="p-6  border-gray-200">
          <form class="flex flex-col pt-3 md:pt-8 justify-center" onsubmit="event.preventDefault();">
            ...
            <div class="flex flex-col w-1/2 pt-4 ">
              ...
              <input type="file" class="shadow appearance-none border rounded w-1/2 py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"  accept="image/jpeg, image/png" name="image" id="file"/>  
            </div>
