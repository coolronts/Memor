<template>
 <div :class="style.body">
  <div :class="style.container">
          <img
            class="style. rounded-lg rounded-b-none"
            :src="imgSrc"
            alt="thumbnail"
            loading="lazy"
          />
          <div class="style. flex justify-between -mt-4 px-4">
            <span class="style. w-auto inline-block ring-4 bg-red-500 ring-gray-800 rounded-full text-xs font-medium text-center text-gray-100 px-3 pt-1"> {{place}} </span>
            <span class="style. w-1/3 flex h-min space-x-1 items-center rounded-full text-gray-400 bg-gray-800 py-1 px-2 text-xs font-medium">
              <i class="style. fas fa-clock"/>
              <p class="style. text-blue-500 font-semibold text-xs">
                6 Mins
              </p>
            </span>
          </div>
          <div class="style. py-2 px-4">
            <h1
              class="style. text-xl font-medium leading-6 tracking-wide text-gray-300 hover:text-blue-500 cursor-pointer"
            >
              <a > {{title}}  </a>
            </h1>
          </div>
