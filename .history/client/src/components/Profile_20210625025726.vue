      ...
      <div :class="style.formContainer">
        <form :class="style.form" onsubmit="event.preventDefault();">
          ...
          <div class="flex flex-col w-1/2 pt-4 ">
            ...
            <input type="file" @change="handleImage" accept="image/*" class="inline shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mt-1 leading-tight focus:outline-none focus:shadow-outline"/>
          </div>
