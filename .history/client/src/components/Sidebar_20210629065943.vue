      ...
      <ul :class="style.list">
        ...
        <li>
          <a :class="style.listItem">
            ...
            <span :class="style.itemName">Logout</span>
          </a>
        </li>
      </ul>
    </div>
    ...
    data(){
      return{
        style:{
          ...
          listItem:"flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-red-600",
          iconContainer:"inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400 hover:text-red-600",
