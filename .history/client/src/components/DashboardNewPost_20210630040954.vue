<template>
  <div :class="style.body">
    <div :class="style.container">
      ...
      <p :class="[style.error,{'visible':responseErrorMessage!=null}]">{{responseErrorMessage}}</p>
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        ...
        style:{
          ...
          error:"text-red-600 pt-4 invisible font-medium text-md text-center",
    ...
    methods: {
      ...
      validation(){
        if(!this.title){
          this.responseErrorMessage = "Field Required"
        }else{
