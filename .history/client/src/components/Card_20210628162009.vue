...
<script>
  ...
  export default {
    ...
    data(){
      return{
        style:{
          body:"flex justify-between m-3 h-full ",
          container:" flex flex-col overflow-hidden h-5/6 max-w-lg mx-auto bg-gray-800 rounded-lg",
          ...
          description:"overflow-hidden text-gray-400 font-normal leading-5 tracking-wide",
