    ...
    <nav class="bg-white dark:bg-gray-800">
        <div class="container p-6 mx-auto">
            <div class="flex justify-between">
              ...
              <div class="pt-2 relative mx-auto text-gray-600 border-3">
                <input class="border-2 border-gray-300 bg-white h-10 px-5 pr-16 rounded-full text-sm" type="search" name="search" placeholder="Search">
