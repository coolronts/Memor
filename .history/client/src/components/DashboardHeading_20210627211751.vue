...
<script>
  ...
  export default{
    ...
    data(){
      return{
        style:{
          headingContainer:"flex px-12  items-center justify-between h-20 shadow-md",
          heading:" w-1/3 text-2xl font-bold text-gray-800  md:text-3xl",  
          body:"flex justify-center w-1/3",
