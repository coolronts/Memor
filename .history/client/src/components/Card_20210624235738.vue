 ...
 <div class="flex justify-between m-3">
  <div class="flex flex-col h-full max-w-lg mx-auto bg-gray-800 rounded-lg">
          <img
            ...
            src="https://www.lifeinnorway.net/wp-content/uploads/2018/10/oslo-very-green-capital.jpg"
            alt="thumbnail"
            loading="lazy"
          />
          <div class="flex justify-between -mt-4 px-4">
            <span class="inline-block ring-4 bg-red-500 ring-gray-800 rounded-full text-xs font-medium text-center text-gray-100 px-3 pt-1">Oslo, Norway</span>
...
export default {
 name:"Card",
 props:['imgSrc', 'title', 'description', 'likes', 'place'],
}
</script>
