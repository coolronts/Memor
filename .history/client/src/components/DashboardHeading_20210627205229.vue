      ...
      <div :class="style.body">
        <div :class="style.container">
          <button @click="dropdownOpen = !dropdownOpen" :class="style.button">
              <i :class="style.icon"/><span :class="style.unreadNotifications "> {{unreadNotifications}} </span> 
          </button>
    ...
    data(){
      return{
        style:{
          ...
          unreadNotifications:"self-end text-sm mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full font-semibold text-white px-2 py-1 rounded-full bg-red-600",
          ...
          icon:"fas fa-bell text-2xl self-center"
        },
        dropdownOpen: false,
        notifications: [],
        postedUsers:[],
