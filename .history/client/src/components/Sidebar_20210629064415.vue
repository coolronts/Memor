...
<div :class="style.body">
  <div :class="style.container">
    <div class="style.headerContainer">
      <a  class="style. block text-2xl font-bold text-center text-gray-800 dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300">MEMOR</a>
    </div>
    <ul class="style. flex flex-col py-4">
      <li @click="switchDashboard(0)">
        <a class="style. flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-gray-800">
          <span class="style. inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="bx bx-home"></i></span>
          <span class="style. text-sm font-medium">Dashboard</span>
        </a>
      </li>
      ...
      <li>
        <a class="hover:text-red-600 flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 ">
