      ...
      <div :class="style.body">
        <div :class="style.container">
          <button @click="dropdownOpen = !dropdownOpen" :class="style.button">
              <i class="fas fa-bell text-xl"/><span :class="style.unreadNotifications "> {{unreadNotifications}} </span> 
          </button>
    ...
    data(){
      return{
        style:{
          ...
          button:"relative z-10 block p-2 focus:outline-none h-10 text-gray-700 rounded-lg",
          unreadNotifications:"text-xs font-semibold text-white p-1 rounded-full bg-red-600",
