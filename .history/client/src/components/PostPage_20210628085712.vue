      ...
      <div :class="style.infoContainer">
        <div :class="style.heading">
          ...
          <div v-if="isEditPlace==true" class="flex flex-wrap">
            <input :class="['outline-white shadow rounded px-1 border-2 border-black',style.place]" v-model="post.place" placeholder="edit me"/>
            <i @click="save(2)" :class="[style.save,'self-end']"/>
          </div>
        ...
        <div v-if="isEditContent==true" class="flex">
          <input  :class="['outline-white shadow rounded mr-2 px-1 border-2 border-black',style.content]" v-model="post.description" placeholder="edit me"/>
