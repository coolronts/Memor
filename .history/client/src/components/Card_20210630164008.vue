    ...
    data(){
      return{
        style:{
          ...
          topPart:"flex justify-between -mt-7 px-4",
          place:" w-auto self-center inline-block ring-4 bg-red-500 ring-gray-800 rounded-full text-base font-medium text-center text-gray-100 px-3 ",
          timeContainer:" w-28 text-center justify-center flex h-min space-x-1 items-center rounded-full text-gray-400 bg-gray-800 py-1 px-2 text-xs font-medium",
