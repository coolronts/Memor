    ...
    <div :class="[style.postContainer,'relative']">
      ...
      <div :class="style.infoContainer">
        ...
        <div v-if="isEditContent==true" class="flex">
          <textarea rows="4" cols="120" :class="['outline-white shadow rounded mr-2 px-1 border-2 border-black',style.content]" v-model="post.description" placeholder="edit me"></textarea>
