    ...
    data(){
      return{
        style:{
          ...
          unreadNotifications:"self-end text-sm mr-2 text-xs font-bold leading-none text-red-100 bg-red-600 rounded-full font-semibold  px-2 py-1 rounded-full bg-red-600",
