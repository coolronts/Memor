              ...
              <div v-for="(notification, index) in notifications" :key="notification.post">
                <div :class="style.notificationContainer">
                 ...
                 <p :class="style.textContainer">
                     <span class="font-bold" href="#"> {{postedUsers[index].name}}  </span> liked on the <span class="font-bold text-blue-500">Upload</span> article . 2m
                 </p>
                </div>
              </div>
            </div>
    ...
    data(){
      return{
        style:{
          ...
          textCOnatiner:"text-gray-600 text-sm mx-2"
        },
        dropdownOpen: false,
        notifications: [],
        postedUsers:[],
