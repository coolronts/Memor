    ...
    <div :class="[style.postContainer,'relative']">
      ...
      <div :class="style.infoContainer">
        <div :class="style.heading">
          ...
          <input  :class="['outline-white shadow rounded mr-2 px-1',style.place]" v-model="post.place" placeholder="edit me"/>
          <i class="self-end animate-bounce fas fa-save text-red-400"/>
           </div>
        </div>
