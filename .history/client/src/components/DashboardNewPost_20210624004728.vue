    ...
    <div class="p-6 bg-white border-b border-gray-200">
      <form class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
        <div class="flex justify-between">
            ...
            <button @click="signIn" class="justify-center w-1/4 mr-3 mt-12 shadow text-white px-4 h-10 bg-red-600 rounded-full hover:bg-red-700 active:shadow-xl mouse transition ease-in duration-200 focus:outline-none">
              <span>Sign In</span>
            </button> 
          </form>
    </div>
