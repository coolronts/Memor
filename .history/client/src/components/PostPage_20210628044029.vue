<template>
  <div class=" bg-gray-300 w-screen h-screen mb-12">
    <div class="bg-white rounded m-24">
      <img src="https://images.unsplash.com/photo-1526666923127-b2970f64b422?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=900&q=60" class="rounded object-cover w-2/3 h-2/3" alt="technology" />
      <div class="p-4 pl-0">
