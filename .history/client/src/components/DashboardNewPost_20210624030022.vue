      ...
      <div class=" overflow-hidden ">
        <div class="p-6  border-gray-200">
          <form class="flex flex-col pt-3 md:pt-8 justify-center" onsubmit="event.preventDefault();">
            ...
            <button @click="post" class="self-center text-center w-1/6 mr-3 mt-12 shadow text-white px-4 h-10 bg-red-600 rounded-full hover:bg-red-700 active:shadow-xl mouse transition ease-in duration-200 focus:outline-none">
              <span>Post</span>
            </button> 
          </form>
        </div>
