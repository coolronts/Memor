      ...
      <div :class="style.body">
        <div :class="style.container">
          <button @click="dropdownOpen = !dropdownOpen" :class="style.button">
              <i class="fas fa-bell text-2xl"><span :class="style.unreadNotifications "> {{unreadNotifications}} </span> </i>
          </button>
    ...
    data(){
      return{
        style:{
          ...
          unreadNotifications:"text-xs font-semibold text-white p-2 rounded-full  bg-red-600",
