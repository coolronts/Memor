  ...
  <div :class="style.body">
    <div :class="style.container">
      <div :class="style.headingContainer">
        <div :class="style.heading">New Post</div>
        <i :class="style.icon"/><p :class="style.notification">5</p>
...
<script>
  ...
  export default {
    ...
    async postData(){
      ...
      try {
        await postService.insertPost(this.title,this.place,this.description,this.imageBase64, userId);
