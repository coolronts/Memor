    ...
    data(){
      return {
        ...
        style:{
          ...
          deleteContainer:"w-1/5 justify-center cursor-pointer flex flex-row items-center h-12 mx-4 mt-6 text-white bg-red-600 rounded",
