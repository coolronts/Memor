    ...
    <nav class="bg-white dark:bg-gray-800">
        <div class="container p-6 mx-auto">
            <div class="flex justify-between">
              ...
              <div class="pt-2 relative mx-auto text-gray-600 border-4">
                <input class="border-4 border-red-900 text-lg bg-white h-10 px-5 pr-16 rounded-full text-sm" type="search" name="search" placeholder="Search">
