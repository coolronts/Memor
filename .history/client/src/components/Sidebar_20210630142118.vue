    ...
    <div :class="style.container">
      ...
      <ul :class="style.list">
        <li @click="switchDashboard(0)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==0},style.listItem]">
        ...
        <li @click="switchDashboard(1)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==1},style.listItem]">
        ...
        <li @click="switchDashboard(2)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==2},style.listItem]">
        ...
        <li @click="switchDashboard(3)">
          <a :class="[{'translate-x-2 text-red-600': this.$store.state.dashboard==3},style.listItem]">
        ...
        <li>
          <a :class="style.listItem">
            <span :class="[style.iconContainer,'bg-red-600 rounded']"><i class="fas fa-sign-out-alt"/></span>
            <span @click="logout" :class="style.itemName">Delete your Account</span>
          </a>
        </li>
      </ul>
    </div>
