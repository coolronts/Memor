<template>
 <div class="bg-white font-family-karla h-screen w-full flex flex-wrap">
   ...
   <div class="w-1/2 shadow-2xl">
    <img class="object-fill w-full h-screen hidden md:block" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTv4h9pMYL3pw3hj_wed4NefPq2YT8XI_C5vw&usqp=CAU">
   </div>
