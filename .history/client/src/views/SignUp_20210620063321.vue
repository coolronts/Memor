<template>
 <div class="bg-white font-family-karla h-screen w-full flex flex-wrap">
   ...
   <div class="w-1/2 shadow-2xl">
    <img class="object-fit w-full h-screen hidden md:block" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7_HYKgT70MbcRwpcSWcXI1shiA91mhZPF_g&usqp=CAU">
   </div>
