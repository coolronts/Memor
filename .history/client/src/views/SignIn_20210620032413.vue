<template>
 <section class="flex flex-col md:flex-row items-center px-24 h-64 py-12">

  <div class="bg-indigo-600 hidden lg:block w-full md:w-1/3 xl:w-2/3 h-screen">
    <img src="https://source.unsplash.com/random" alt="" class="w-full h-full ">
  </div>
