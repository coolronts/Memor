<template>
 <div class="bg-white font-family-karla h-screen w-full flex flex-wrap">
       ...
       <div class="w-full py-6">
        <div class="flex">
         <div class="w-1/3">
          ...
          <div class="text-xs text-center md:text-base">Personal Info</div>
         </div>
        <div class="w-1/3">
         <div class="relative mb-2">
         ...
         <div class="text-xs text-center md:text-base">Account Info</div>
        </div>
        <div class="w-1/3">
         <div class="relative mb-2">
          <div class="absolute flex align-center items-center align-middle content-center" style="width: calc(100% - 2.5rem - 1rem); top: 50%; transform: translate(-50%, -50%)">
   ...
   <div class="w-1/2 shadow-2xl">
    <img class="object-scale-down w-full h-screen hidden md:block" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7_HYKgT70MbcRwpcSWcXI1shiA91mhZPF_g&usqp=CAU">
   </div>
