        ...
        <div class="flex flex-col mt-16 justify-center md:justify-start  pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
          ...
          <form @onsubmit="register" class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
            <div class="flex flex-col pt-4">
              ...
              <p v-if="error.username.len" :class="style.error"> Username must be at least 6 characters and not more than 12 characters</p>
              <p v-if="error.username.required" :class="style.error"> Username is required</p>
            </div>
            <div class="flex flex-col pt-4">
              <label for="email" class="text-lg">Email</label>
              <input v-model="email" type="text" id="email" placeholder="your@email.com" :class="style.input">
              <p v-if="error.email.len" :class="style.error"> Email must be at least 6 characters and not more than 12 characters</p>
              <p v-if="error.email.required" :class="style.error"> Email is required</p>
            ...
            <div class="flex flex-col pt-4 mb-8">
              ...
              <p v-if="error.password.len" :class="style.error"> Password must be at least 6 characters and not more than 12 characters</p>
              <p v-if="error.password.required" :class="style.error"> Password is required</p>
            </div>
    ...
    data(){
      return {
        ...
        style:{
          ...
          error:"text-red-600 font-medium text-sm text-center"
        }
      }
    },
