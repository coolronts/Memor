      ...
      <div :class="style.signInContainer">
        ...
        <div :class="style.main">
          ...
          <div :class="style.suggestionContainer">
            <p>Don't have an account? <a :class="style.suggestion">Register here.</a></p>
          </div>
        </div>
      </div>
    ...
    data(){
      return {
        ...
        style:{
          ...
          suggestion:"text-red-600 underline font-semibold",
    ...
    methods: {
      ...
      async register(){
        ...
        if(this.noError){
          ...
          try {
            await authService.registerUser(this.username,this.email,this.password, this.imageBase64) 
