        ...
        <div class="flex flex-col mt-16 justify-center md:justify-start  pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
          ...
          <form class="flex flex-col pt-3 md:pt-8" onsubmit="event.preventDefault();">
            ...
            <div class="flex flex-col pt-4">
              ...
              <input v-model="formInput.email" type="email" id="email" placeholder="your@email.com" :class="style.input">
            </div>
            <div class="flex flex-col pt-4 mb-8">
              <label for="password" class="text-lg">Password</label>
              <input v-model="formInput.password" type="password" id="password" placeholder="Password" :class="style.input">
            </div>
